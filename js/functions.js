...
function buildSessionTable(responseData)
{
    ...
    for(var i=0; i < arr.length; i++)
    {
        ...
        <tr>
            ...
            {
                table += `<td style="text-align:center; position: relative" ><svg style="position: absolute; left: 10px" class="bi bi-award-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
